...
### YOUR SERVER ADDRESS ###
    ...
    ServerName $domain
### SETTINGS ###
    DocumentRoot /var/www/bibanto
    <Directory /var/www/bibanto>
    ...
    SetEnv HOME /var/www/bibanto
    SetEnv HTTP_HOME /var/www/bibanto
...
webroot() {
if eval "certbot certonly --webroot --webroot-path /var/www/bibanto $default_le"
then
    echo "success" > /tmp/le_test
else
    echo "fail" > /tmp/le_test
